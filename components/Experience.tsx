...
export default function Experience({}: Props) {
  return (
    ...
    >
      ...
      <div className="w-full mt-20 flex space-x-10 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar-track-transparent scrollbar-thin xl:space-x-14 dark:scrollbar-track-transparent scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-300/20 scrollbar-thumb-rounded-full justify-center">
